...
module.exports = class HabitsTracked {
    constructor(data){
        ...
        this.userInfo = {id: data.user_id, username: data.username},
        ...
        return new Promise (async(resolve, reject) => {
            try {
                ...
                let user = userData.rows.map(u => ({
                    ...
                    userInfo : {id: u.user_id, username: u.username},
